...
import com.project.communityorganizer.EventCreation;
import com.project.communityorganizer.R;
import com.project.communityorganizer.communication.SocketOperator;
import com.project.communityorganizer.interfaces.IAppManager;
import com.project.communityorganizer.interfaces.ISocketOperator;
import com.project.communityorganizer.interfaces.IUpdateData;
...
import com.project.communityorganizer.tools.MessageController;
import com.project.communityorganizer.tools.XMLHandler;
...
*/	
	...
	public String authenticateUser(String usernameText, String passwordText) throws UnsupportedEncodingException 
	{
		...
		if (result != null && !result.equals(SignInActivity.AUTHENTICATION_FAILED)) 
		{			
